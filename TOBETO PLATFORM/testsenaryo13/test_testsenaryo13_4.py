...
class TestTcbosbirakma(): 
    ...
    def test_login(self):
        ...
        #kisisel_bilgilerim_button = WebDriverWait(self.driver,5).until(expected_conditions.visibility_of_element_located((By.XPATH, "//*[@id='offcanvasExample']/div[2]/div[2]/div[2]/div/ul/li[1]/a")))
        #kisisel_bilgilerim_button()
        #sleep(5)
